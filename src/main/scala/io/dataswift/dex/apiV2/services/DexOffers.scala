...
import io.dataswift.dex.apiV2.models.{ Offer, OfferClaimSummary, OfferClaimsInfo, OfferRegistration }
import io.dataswift.dex.apiV2.services.Errors._
...
trait DexOffers {
  ...
  import io.dataswift.dex.apiV2.json.DexJsonFormats._
