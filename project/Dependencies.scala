...
object Dependencies {
  ...
  object Library {
    ...
    object Test{
      ...
      val funsuite = "org.scalatest" %% "scalatest-funsuite" % "3.2.0"
      val testpluscheck = "org.scalatestplus" %% "scalacheck-1-14" % "3.2.0.0"
      val matchers = "org.scalatest" %% "scalatest-mustmatchers" % "3.2.0"
    }
  }
}
