...
object Dependencies {
  ...
  object Library {
    ...
    object Test {
      ...
      val scalatest     = "org.scalatest"     %% "scalatest"              % "3.2.4"   % "it,test"
      val funsuite      = "org.scalatest"     %% "scalatest-funsuite"     % "3.2.4"   % "it,test"
      val testpluscheck = "org.scalatestplus" %% "scalacheck-1-14"        % "3.2.0.0" % "it,test"
      val matchers      = "org.scalatest"     %% "scalatest-mustmatchers" % "3.2.4"   % "it,test"
